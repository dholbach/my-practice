...
**Snapshot — 2026-09-15 (`bb4afb6`)**

| | |
| --- | --- |
| Tracked lines | 98,252 |
| App code | 28,427 |
| Test code | 37,623 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| app | 25,445 | 27,099 | 28,036 | 28,427 | +12% |
| tests | 20,986 | 27,899 | 35,581 | 37,623 | +79% |
| templates | 12,806 | 12,617 | 12,564 | 12,637 | -1% |
| js | 2,719 | 2,617 | 2,822 | 2,721 | +0% |
| css | 2,647 | 2,641 | 2,645 | 2,880 | +9% |
| migrations | 1,029 | 3,786 | 4,389 | 1,023 | -1% |
| docs | 13,657 | 13,681 | 14,481 | 12,941 | -5% |
