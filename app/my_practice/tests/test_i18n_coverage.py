...
KNOWN_UNWRAPPED_TEMPLATES = {
    ...
    "my_practice/todo_confirm_delete.html",
    "my_practice/todo_list.html",
    "my_practice/withdrawal_confirm_delete.html",
}
