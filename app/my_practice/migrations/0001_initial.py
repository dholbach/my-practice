    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "has_invoice",
                    models.BooleanField(default=False, verbose_name="Invoice available"),
                ),
                (
                    "is_tax_deductible",
                    models.BooleanField(default=True, verbose_name="Tax deductible"),
                ),
                (
                    "is_filed_in_tax_return",
                    models.BooleanField(default=False, verbose_name="Filed in tax return"),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(default="", max_length=200, verbose_name="Practitioner name"),
                ),
                (
                    "slug",
                    models.SlugField(
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Inactive practices are not shown",
                        verbose_name="Active",
                    ),
                ),
                (
                ...
                (
                    "postal_code",
                    models.CharField(default="", max_length=20, verbose_name="Postal code"),
                ),
                ...
                (
                    "bank_name",
                    models.CharField(default="", max_length=200, verbose_name="Bank name"),
                ),
                ...
                (
                    "memberships_de",
                    models.TextField(blank=True, default="", verbose_name="Memberships (German)"),
                ),
                (
                    "memberships_en",
                    models.TextField(blank=True, default="", verbose_name="Memberships (English)"),
                ),
                (
                    "logo",
                    models.ImageField(
                        blank=True, null=True, upload_to="practice/", verbose_name="Logo"
                    ),
                ),
                (
                    "signature",
                ...
                (
                    "payment_terms_days",
                    models.IntegerField(default=14, verbose_name="Payment term (days)"),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                my_practice.models.timeoff.TimeOff.Type["VACATION"],
                                "Urlaub / Vacation",
                            ),
                            (
                                my_practice.models.timeoff.TimeOff.Type["HOLIDAY"],
                                "Feiertag / Public Holiday",
                            ),
                            (my_practice.models.timeoff.TimeOff.Type["SICK"], "Krank / Sick Leave"),
                            (
                                my_practice.models.timeoff.TimeOff.Type["TRAINING"],
                                "Fortbildung / Training",
                            ),
                            (my_practice.models.timeoff.TimeOff.Type["OTHER"], "Sonstiges / Other"),
                        ],
                        default="vacation",
                        max_length=20,
                        verbose_name="Type",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "reason",
                    models.TextField(help_text="Why is this step paused?", verbose_name="Reason"),
                ),
                (
                    "paused_until",
                    models.DateField(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                my_practice.models.client.ClientDocument.DocumentType[
                                    "INTRO_NOTES"
                                ],
                                "Intro meeting (notes)",
                            ),
                            ...
                            (
                                my_practice.models.client.ClientDocument.DocumentType["OTHER"],
                                "Other",
                            ),
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "intake_notes",
                    my_practice.fields.EncryptedTextField(
                        blank=True,
                ...
                (
                    "arbeitsdiagnose",
                    my_practice.fields.EncryptedCharField(
                        blank=True,
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                my_practice.models.invoice.Invoice.Status["WRITTEN_OFF"],
                                "Written off",
                            ),
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Leave empty if still active",
                        null=True,
                        verbose_name="To",
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "refresh_token",
                    models.TextField(blank=True, help_text="Refresh token for token renewal"),
                ),
                (
                    "token_uri",
                    models.CharField(default="https://oauth2.googleapis.com/token", max_length=500),
                ),
                ...
                (
                    "expires_at",
                    models.DateTimeField(blank=True, help_text="Token expiration time", null=True),
                ),
                (
                    "is_active",
                    models.BooleanField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "description",
                    models.TextField(
                        blank=True, help_text="Optional: purpose", verbose_name="Notes"
                    ),
                ),
                (
                    "category",
                    models.CharField(
                        choices=[
                            ...
                            (
                                my_practice.models.financial.CompanyWithdrawal.Category[
                                    "PRIVATE_TRANSFER"
                                ],
                                "Private transfer",
                            ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                my_practice.models.inquiry.InquiryStatus["INTRO_MEETING"],
                                "Intro meeting",
                            ),
                            ...
                            (
                                my_practice.models.inquiry.InquiryStatus["UNREACHABLE"],
                                "Unreachable",
                            ),
                            (
                                my_practice.models.inquiry.InquiryStatus["NOT_SUITABLE"],
                                "Not a match",
                            ),
                        ],
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        ...
                        max_length=200,
                        verbose_name="Payer/payee name",
                    ),
                ),
                (
                    "payer_iban",
                    models.CharField(blank=True, max_length=34, verbose_name="Payer/payee IBAN"),
                ),
                (
                    "reference",
                    models.TextField(
                ...
                (
                    "imported_at",
                    models.DateTimeField(auto_now_add=True, verbose_name="Imported on"),
                ),
                (
                    "processed",
                    models.BooleanField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(help_text="Short description of the task", max_length=255),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (
                                my_practice.models.todo.PracticeTodo.Category["ADMIN"],
                                "Administrative",
                            ),
                            (
                                my_practice.models.todo.PracticeTodo.Category["LEARNING"],
                                "Learning/Research",
                            ),
                            (
                                my_practice.models.todo.PracticeTodo.Category["FINANCIAL"],
                                "Financial/Accounting",
                            ),
                            (
                                my_practice.models.todo.PracticeTodo.Category["CLIENT"],
                                "Client-related",
                            ),
                            (
                                my_practice.models.todo.PracticeTodo.Category["PRACTICE"],
                                "Practice Management",
                            ),
                            (my_practice.models.todo.PracticeTodo.Category["OTHER"], "Other"),
                        ],
                        default="other",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (my_practice.models.todo.PracticeTodo.Priority["LOW"], "Low"),
                            (my_practice.models.todo.PracticeTodo.Priority["MEDIUM"], "Medium"),
                            (my_practice.models.todo.PracticeTodo.Priority["HIGH"], "High"),
                            (my_practice.models.todo.PracticeTodo.Priority["URGENT"], "Urgent"),
                        ],
                        default="medium",
                ...
                (
                    "due_date",
                    models.DateField(blank=True, help_text="Optional due date", null=True),
                ),
                (
                    "completed_at",
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                my_practice.models.todo.PracticeTodo.TaskType[
                                    "MISSING_SESSION_LOG"
                                ],
                                "Missing session log",
                            ),
                            ...
                            (
                                my_practice.models.todo.PracticeTodo.TaskType["SUPERVISION"],
                                "Supervision",
                            ),
                            (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "default_duration",
                    models.IntegerField(default=60, verbose_name="Default duration (minutes)"),
                ),
                (
                    "practice",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "google_event_id",
                    models.CharField(max_length=255, unique=True, verbose_name="Google Event ID"),
                ),
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            (
                                my_practice.models.calendar.PendingCalendarEvent.Status[
                                    "CANCELLED"
                                ],
                                "Cancelled",
                            ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content",
                    my_practice.fields.EncryptedTextField(
                        help_text="Supervision question or topic (encrypted)",
                ...
                (
                    "resolved_date",
                    models.DateField(blank=True, null=True, verbose_name="Discussed on"),
                ),
                (
                    "client",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["alias_name"], name="my_practice_alias_n_509cfa_idx")
                ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "content",
                    my_practice.fields.EncryptedTextField(
                        help_text="Note content (encrypted, markdown supported)",
                        verbose_name="Content",
                    ),
                ),
                (
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["practice", "transaction_date"], name="my_practice_practic_78a6f3_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="banktransaction",
            index=models.Index(
                fields=["practice", "processed"], name="my_practice_practic_527efb_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="banktransaction",
            index=models.Index(
                fields=["practice", "match_confidence"], name="my_practice_practic_68b33d_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="banktransaction",
