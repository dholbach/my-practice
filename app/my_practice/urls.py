...
urlpatterns = [
    ...
    path("marketing-periods/new/", views.MarketingPeriodCreateView.as_view(), name="marketing_period_create"),
    path("marketing-periods/<int:pk>/edit/", views.MarketingPeriodUpdateView.as_view(), name="marketing_period_edit"),
    path("marketing-periods/<int:pk>/delete/", views.MarketingPeriodDeleteView.as_view(), name="marketing_period_delete"),
